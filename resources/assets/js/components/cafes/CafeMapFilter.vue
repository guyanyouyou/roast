    ...
    <div id="cafe-map-filter">
        <div class="grid-container">
            <div class="grid-x grid-padding-x">
                <div class="largr-12 medium-12 small-12 cell">
                    <label>搜索</label>
        ...
        <div class="brew-methods-container">
            <div class="filter-brew-method" v-on:click="toggleBrewMethodsFilter(method.method)" v-bind:class="{'active':brewMethods.indexOf(method.method) > -1}" v-for="method in cafeBrewMethods" >
                {{ method.method}}
            </div>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            toggleBrewMethodsFilter(method){
